...
from models import Patient, ModelFeatures, LabTest, Appointment, Account
import json
...
def get_data_clerk_patient_data(session: Session, patient_id: int) -> Optional[Dict[str, Any]]:
    ...
    features = (mf.input_features or {}) if mf else {}
